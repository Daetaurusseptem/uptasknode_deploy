...
var LocalStrategy = require('passport-local').Strategy; //Necesitamos el modelo de usuario para hacer la comprobacion de
//usuarios


var Usuarios = require('../models/Usuarios'); // Local Strategy - login con credenciales propias
// Local Strategy - login con credenciales propias


passport.use(new LocalStrategy( // Nuestro usuario requerira email y password en orden para poder logearse
{
  usernameField: 'email',
